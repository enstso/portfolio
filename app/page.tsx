...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-neutral-900 dark:text-neutral-100 px-6 py-12">
      {/* Introduction Section */}
      <section className="text-center max-w-3xl">
        <h1 className="text-3xl font-bold mb-4">
          👋 Hi, I’m <span className="text-neutral-900 dark:text-neutral-100">Enstso</span>
        </h1>
        <p className="text-neutral-600 dark:text-neutral-200 text-lg leading-7 mb-6">
        ...
        <p className="text-neutral-600 dark:text-neutral-200 text-lg leading-7">
