  ...
  return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        ...
        <section className="relative px-4 sm:px-6 lg:px-12 py-12 sm:py-16 lg:py-20 text-center max-w-6xl mx-auto">
          ...
          {/* Badge Responsive */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 rounded-full text-xs sm:text-sm font-semibold mb-6 sm:mb-8 shadow-sm">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-slate-900 via-blue-800 to-slate-900 dark:from-white dark:via-blue-400 dark:to-white bg-clip-text text-transparent leading-tight">
            IT Analyst Engineer
            <span className="block text-xl sm:text-2xl md:text-3xl lg:text-4xl mt-2 text-slate-600 dark:text-slate-400">
              Enstso JANVIER
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 mb-8 sm:mb-12">
            <div className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-white dark:bg-slate-800 rounded-full shadow-sm border border-slate-200 dark:border-slate-700">
              <div className="w-2 h-2 sm:w-3 sm:h-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full"></div>
              <span className="text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300">Tertiary sector</span>
            </div>
            <div className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-white dark:bg-slate-800 rounded-full shadow-sm border border-slate-200 dark:border-slate-700">
              <div className="w-2 h-2 sm:w-3 sm:h-3 bg-gradient-to-r from-green-500 to-green-600 rounded-full"></div>
            ...
            {expertise.map((item, index) => (
                ...
                >
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="flex-shrink-0 p-2 sm:p-3 bg-blue-50 dark:bg-blue-900/30 rounded-lg sm:rounded-xl group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50 transition-colors">
                      {item.icon}
                    </div>
        ...
        <section className="px-4 sm:px-6 lg:px-12 py-12 sm:py-16 bg-gradient-to-r from-slate-100 to-blue-50 dark:from-slate-800 dark:to-slate-900">
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 text-center">
              <div className="p-4 sm:p-6 bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                <div className="text-2xl sm:text-3xl font-bold text-blue-600 mb-1 sm:mb-2">3+</div>
                <div className="text-slate-600 dark:text-slate-400 font-medium text-sm sm:text-base">Years Experience</div>
              </div>
              <div className="p-4 sm:p-6 bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                <div className="text-2xl sm:text-3xl font-bold text-blue-600 mb-1 sm:mb-2">15+</div>
                <div className="text-slate-600 dark:text-slate-400 font-medium text-sm sm:text-base">Technologies Mastered</div>
              </div>
              <div className="p-4 sm:p-6 bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                <div className="text-2xl sm:text-3xl font-bold text-blue-600 mb-1 sm:mb-2">100%</div>
                <div className="text-slate-600 dark:text-slate-400 font-medium text-sm sm:text-base">Client Satisfaction</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-4 sm:px-6 lg:px-12 py-12 sm:py-16 text-center max-w-4xl mx-auto">
          <div className="p-6 sm:p-8 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl sm:rounded-3xl shadow-2xl text-white">
