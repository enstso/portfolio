...
export default function Projects({items}: Readonly<ProjectProps>) {
                    ...
                    >
                        ...
                        >
                            <div className="flex items-start justify-between gap-3 sm:gap-4">
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div
                                        className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-slate-600 dark:text-slate-400">
                          ...
                          {new Date(item.date).toLocaleDateString("en-US", {
                              ...
                              day: "numeric"
                                ...
                                >
                                    {isOpen ? (
                                        <ChevronUp
                                            className="h-4 w-4 sm:h-5 sm:w-5 text-slate-600 dark:text-slate-400"/>
                                    ) : (
                                        <ChevronDown
                                            className="h-4 w-4 sm:h-5 sm:w-5 text-slate-600 dark:text-slate-400"/>
                                    )}
                        ...
                        {isOpen && (
                            <div className="px-4 sm:px-6 pb-4 sm:pb-6">
                                <div
                                    className="pt-3 sm:pt-4 border-t border-slate-200 dark:border-slate-700 space-y-4 sm:space-y-6">
