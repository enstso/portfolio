        ...
        {items.map((item, index) => {
          ...
          return (
              <div
                  key={index}
                  className={cn(
                      "bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 transition-all duration-300",
                      ...
                      <div className="pt-4 border-t border-slate-200 dark:border-slate-700 space-y-6">
                        ...
                        <div className="pt-2">
                          <a
                              ...
                              className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg transition-colors duration-300 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-slate-800"
                          >
